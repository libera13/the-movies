<template>
  <div>
    <router-link :to="{ path: `/movie/${media.id}` }" class="link">
        ...
        <v-col cols="7" sm="8" md="9" align-self="end">
          <div class="text-div">
            <div class="title-div">
              ...
              <div v-if="keyword" class="media-subtitle">
                Featured in {{ keyword }}
              </div>
...
.background-div {
  ...
  background: linear-gradient(
    0deg,
    rgba(0, 0, 0, 1) 0%,
    rgba(8, 7, 7, 0.8981967787114846) 55%,
    rgba(14, 12, 12, 0.7525385154061625) 70%,
    rgba(24, 21, 21, 0.5116421568627452) 85%,
    rgba(0, 0, 0, 0) 100%
  );
}
.overlay-row {
